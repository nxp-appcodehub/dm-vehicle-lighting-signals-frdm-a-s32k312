...
#define BTN1_VOLTAGE_MIN    2002U
#define BTN1_VOLTAGE_MAX    4095U
#define BTN2_VOLTAGE_MIN    1640U
#define BTN2_VOLTAGE_MAX    2001U
#define BTN3_VOLTAGE_MIN    1268U
#define BTN3_VOLTAGE_MAX    1639U
#define BTN4_VOLTAGE_MIN    903U
#define BTN4_VOLTAGE_MAX    1267U
#define BTN5_VOLTAGE_MIN    542U
#define BTN5_VOLTAGE_MAX    902U
#define BTN6_VOLTAGE_MAX    541U
...
static uint8 GetButtonFromVoltage(uint16 ui16VoltageMv) {
	...
	if ((ui16VoltageMv >= BTN1_VOLTAGE_MIN)
		...
		ui8ButtonId = 5U;
	} else if (ui16VoltageMv <= BTN6_VOLTAGE_MAX) {
		ui8ButtonId = 6U;
	} else {
		ui8ButtonId = 0U;
	}
